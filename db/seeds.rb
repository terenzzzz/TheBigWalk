...
(1..20).each do |check_id|
    ...
    #Checkpoint.create(name: Faker::Address.unique.street_name) do |checkpoint|
        ...
        if Checkpoint.where(id: check_id).first
...
# #Account for walker
User.where(email:'walker@test.com').first_or_create(name:'testWalker', mobile:'00000000000', password:'Test123.', password_confirmation:'Test123.',tag_id:'1')
if User.where(email:'walker@test.com').first
    puts "Created Walker Account Successfully"
    puts "-------------------------------------"
end
...
User.where(email:'marshal@test.com').first_or_create(name:'testWalker', mobile:'00000000000', password:'Test123.', password_confirmation:'Test123.',tag_id:'2')
if User.where(email:'marshal@test.com',name:'testMarshal', mobile:'00000000000',tag_id:'2').first
...
#Account for Admin
User.where(email:'admin@test.com').first_or_create(name:'testAdmin', mobile:'00000000000', password:'Test123.', password_confirmation:'Test123.',tag_id:'3')
if User.where(email:'admin@test.com',name:'testAdmin', mobile:'00000000000', tag_id:'3').first
